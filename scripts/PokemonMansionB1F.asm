...
MewTrainerHeader:
	trainer EVENT_BEAT_MEW, 0, PokemonMansionMewBattleText, PokemonMansionMewBattleText, PokemonMansionMewBattleText
	db -1 ; end

PokemonMansionMewBattleText:
	text_far _PokemonMansionMewBattleText
	text_asm
	ld a, MEW
	call PlayCry
