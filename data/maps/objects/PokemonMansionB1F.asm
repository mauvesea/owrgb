...
PokemonMansionB1F_Object:
	...
	object_event  5, 13, SPRITE_MONSTER, WALK, ANY_DIR, TEXT_POKEMONMANSIONB1F_MEW, MEW, 10
	...
	object_event 25,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_SOLARBEAM, TM_SOLARBEAM
	object_event 16, 20, SPRITE_POKEDEX, STAY, NONE, TEXT_POKEMONMANSIONB1F_DIARY
	object_event  5,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_SECRET_KEY, SECRET_KEY
