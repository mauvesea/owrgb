...
Route21_Object:
	...
	def_bg_events
	bg_event 16, 51, TEXT_ROUTE21_SIGN
	...
	object_event  5, 60, SPRITE_SWIMMER, STAY, RIGHT, TEXT_ROUTE21_SWIMMER4, OPP_SWIMMER, 14
	object_event 15, 71, SPRITE_SWIMMER, STAY, LEFT, TEXT_ROUTE21_SWIMMER5, OPP_SWIMMER, 15
	object_event  4, 72, SPRITE_FISHER, STAY, LEFT, TEXT_ROUTE21_FISHER3, OPP_FISHER, 8
	object_event  7, 73, SPRITE_FISHER, STAY, RIGHT, TEXT_ROUTE21_FISHER4, OPP_FISHER, 10
