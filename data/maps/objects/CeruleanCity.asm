	...
	const_export CERULEANCITY_TM28
...
CeruleanCity_Object:
	...
	object_event 16, 18, SPRITE_SUPER_NERD, WALK, UP_DOWN, TEXT_CERULEANCITY_SUPER_NERD1
	...
	object_event  4, 12, SPRITE_ROCKET, STAY, DOWN, TEXT_CERULEANCITY_SUPER_NERD3
	object_event 27, 12, SPRITE_GUARD, STAY, DOWN, TEXT_CERULEANCITY_GUARD2
	object_event 30,  8, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCITY_TM28, TM_DIG
