	...
	const_export CELADONMART3F_SUGIMORI
...
CeladonMart3F_Object:
	...
	object_event  8,  2, SPRITE_GAMEBOY_GIRL, STAY, DOWN, TEXT_CELADONMART3F_GAMEBOY_KID3
	object_event  2,  5, SPRITE_LITTLE_BOY, STAY, UP, TEXT_CELADONMART3F_LITTLE_BOY
	object_event  9,  4, SPRITE_CLERK, STAY, NONE, TEXT_CELADONMART3F_SUGIMORI
