...
SafariZoneWest_Object:
	...
	bg_event  5,  5, TEXT_SAFARIZONEWEST_FIND_WARDENS_TEETH_SIGN
	bg_event  0,  0, TEXT_SAFARIZONEWEST_TRAINER_TIPS
	...
	object_event 20,  7, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_GOLD_TEETH, FLOATIES
