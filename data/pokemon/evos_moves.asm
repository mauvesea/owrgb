...
; Evolutions
	...
	db EVOLVE_ITEM, LINK_CABLE_ITEM, 1, ALAKAZAM
	db 0
; Learnset
	db 16, CONFUSION
	db 20, DISABLE
...
; Evolutions
	...
	db EVOLVE_ITEM, LINK_CABLE_ITEM, 1, GOLEM
	db 0
; Learnset
	db 11, DEFENSE_CURL
	db 16, ROCK_THROW
...
; Evolutions
	...
	db EVOLVE_ITEM, LINK_CABLE_ITEM, 1, MACHAMP
	db 0
; Learnset
	db 20, LOW_KICK
	db 25, LEER
...
; Evolutions
	...
	db EVOLVE_ITEM, LINK_CABLE_ITEM, 1, GENGAR
	db 0
; Learnset
	db 29, HYPNOSIS
	db 38, DREAM_EATER
