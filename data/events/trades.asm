...
; entries correspond to TRADE_FOR_* constants
	...
	npctrade SPEAROW,    FARFETCHD, TRADE_DIALOGSET_EVOLUTION,     "DUX"        ; used in VERMILION_TRADE_HOUSE
	npctrade SLOWBRO,    LICKITUNG, TRADE_DIALOGSET_EVOLUTION,    "MARC"       ; used in ROUTE_18_GATE_2F
