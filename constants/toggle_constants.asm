...
; after battle and are detected in wToggleableObjectList.)
	...
	const TOGGLE_MT_MOON_ROCKET_1
	const TOGGLE_MT_MOON_ROCKET_2
	const TOGGLE_MT_MOON_ROCKET_3
	const TOGGLE_MT_MOON_ROCKET_4
	...
	const TOGGLE_ROCKETHIDEOUTB1F_ROCKET1
	const TOGGLE_ROCKETHIDEOUTB1F_ROCKET2
	const TOGGLE_ROCKETHIDEOUTB1F_ROCKET3
	const TOGGLE_ROCKETHIDEOUTB1F_ROCKET4
	const TOGGLE_ROCKETHIDEOUTB1F_ROCKET5
	...
	const TOGGLE_ROCKETHIDEOUTB2F_ROCKET
	...
	const TOGGLE_ROCKETHIDEOUTB3F_ROCKET1
	const TOGGLE_ROCKETHIDEOUTB3F_ROCKET2
	...
	const TOGGLE_ROCKETHIDEOUTB4F_ROCKET1
	const TOGGLE_ROCKETHIDEOUTB4F_ROCKET2
	const TOGGLE_ROCKETHIDEOUTB4F_ROCKET3
	...
	const TOGGLE_POKEMON_MANSION_B1F_MEW
	...
	toggle_consts_for CELADON_CHIEF_HOUSE
	const TOGGLE_CELADONCHIEFHOUSE_ROCKET ; E1

	toggle_consts_for CELADON_CITY
	const TOGGLE_CELADONCITY_ROCKET1 ; E1
	const TOGGLE_CELADONCITY_ROCKET2 ; E1
	...
	toggle_consts_for SAFARI_ZONE_SECRET_HOUSE
	const TOGGLE_SAFARI_ZONE_CHIEF
