...
; Pallet Town events
	...
	const EVENT_OAK_FIGHT_1
	const EVENT_OAK_FIGHT_2
...
; Celadon City events
	...
	const EVENT_SUGIMORI_FOUND
	const EVENT_MASUDA_FOUND
...
; Fuchsia City events
	...
	const EVENT_CHIEF_IN_SECRET_HOUSE
...
; Mt. Moon events
	...
	const EVENT_DEFEATED_ALL_ROCKETS_MT_MOON
...
; Seafoam Islands events
	...
	const_skip 6
	const EVENT_BEAT_MOLTRES_DUNGEON

;	Gym Leader Castle
	const EVENT_CASTLE_HITMONCHAN
	const EVENT_CASTLE_HITMONLEE
	const EVENT_CASTLE_CHARMANDER
	const EVENT_CASTLE_BULBASAUR
	const EVENT_CASTLE_SQUIRTLE
	const EVENT_CASTLE_EEVEE
	const EVENT_CASTLE_KABUTO
	const EVENT_CASTLE_OMANYTE
	const EVENT_CASTLE_COMPLETE

	const EVENT_BEAT_CHAMP_CUP_BROCK
	const EVENT_BEAT_CHAMP_CUP_MISTY
	const EVENT_BEAT_CHAMP_CUP_SURGE
	const EVENT_BEAT_CHAMP_CUP_ERIKA
	const EVENT_BEAT_CHAMP_CUP_KOGA
	const EVENT_BEAT_CHAMP_CUP_SABRINA
	const EVENT_BEAT_CHAMP_CUP_BLAINE
	const EVENT_BEAT_CHAMP_CUP_JUNIOR
